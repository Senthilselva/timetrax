...
class LoginAwareAppBar extends Component {
  constructor(props) {
    super(props);
    this.state = { open: false, loggedIn: Auth._loggedIn(), loginName: "" };
    this.handleToggle = this.handleToggle.bind(this);
    this.title = null;
    this.onLeftIconButtonTouchTap = null,
  ...
  render() {
    return (
      <div>
        <AppBar title="Timetrax" onLeftIconButtonTouchTap={this.handleToggle} iconElementRight=
        {this.state.loggedIn ? <PulldownMenu /> : <LoginLink loginName={this.state.loginName} />}
        />
       </div>
    )
  }
...
class LoginLink extends Component {
  ...
  render() {
    return (
      <div>
        {this.props.loginName ? this.props.loginName : <Link to="/login">Login</Link>}
      </div>
 ...
 render() {
    return (
      ...
      <div className="mainContainer">
         <LoginAwareAppBar title="TimeTrax" onLeftIconButtonTouchTap={this.handleToggle} iconElementRight={this.handleLoginLink}/>
